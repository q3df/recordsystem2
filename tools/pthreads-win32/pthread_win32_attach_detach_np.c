...
pthread_win32_process_attach_np ()
{
  ...
  WideCharToMultiByte(CP_ACP, 0, QuserExDLLPathBuf, wcslen(QuserExDLLPathBuf)+1, QuserExDLLPathBufA , sizeof(QuserExDLLPathBuf), NULL, NULL); 
  if(GetSystemDirectory(QuserExDLLPathBuf, sizeof(QuserExDLLPathBuf)) &&
     0 == strncat_s(QuserExDLLPathBufA, (unsigned int)sizeof(QuserExDLLPathBufA), "\\QUSEREX.DLL", 12))
  {
    ptw32_h_quserex = LoadLibrary(QuserExDLLPathBuf);
  }
#endif
