...
#ifndef PROTOBUF_echoservice_2eproto__INCLUDED
#define PROTOBUF_echoservice_2eproto__INCLUDED
...
class EchoRequest : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_echoservice_2eproto();
  friend void protobuf_AssignDesc_echoservice_2eproto();
  friend void protobuf_ShutdownFile_echoservice_2eproto();
...
class NullResponse : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:service.NullResponse)
 private:
  inline void set_has_msg();
  inline void clear_has_msg();
...
// optional string msg = 1;
inline bool NullResponse::has_msg() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NullResponse::set_has_msg() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NullResponse::clear_has_msg() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void NullResponse::clear_msg() {
  if (msg_ != &::google::protobuf::internal::kEmptyString) {
    msg_->clear();
  }
  clear_has_msg();
}
inline const ::std::string& NullResponse::msg() const {
  return *msg_;
}
inline void NullResponse::set_msg(const ::std::string& value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void NullResponse::set_msg(const char* value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline void NullResponse::set_msg(const char* value, size_t size) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline ::std::string* NullResponse::mutable_msg() {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    msg_ = new ::std::string;
  }
...
inline ::std::string* NullResponse::release_msg() {
  clear_has_msg();
  if (msg_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void NullResponse::set_allocated_msg(::std::string* msg) {
  if (msg_ != &::google::protobuf::internal::kEmptyString) {
    delete msg_;
  }
  if (msg) {
...
#endif  // PROTOBUF_echoservice_2eproto__INCLUDED
