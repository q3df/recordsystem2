...
void Q3SysCall::LocateGameData( gentity_t *gEnts, int numGEntities, int sizeofGEntity_t,
...
int Q3SysCall::EntitiesInBox( const vec3_t mins, const vec3_t maxs, int *list, int maxcount ) {
...
int Q3SysCall::AASPredictRoute(void /*struct aas_predictroute_s*/ *route, int areanum, vec3_t origin,
...
int Q3SysCall::AASAlternativeRouteGoals(vec3_t start, int startareanum, vec3_t goal, int goalareanum, int travelflags,
...
float Q3SysCall::Sin(float value) {
	return syscall_(G_SIN, value);
}

float Q3SysCall::Cos(float value) {
	return syscall_(G_COS, value);
}

float Q3SysCall::ATan2(float a, float b) {
	return syscall_(G_ATAN2, a, b);
}

float Q3SysCall::Sqrt(float value) {
	return syscall_(G_SQRT, value);
}
...
float Q3SysCall::Floor(float value) {
	return syscall_(G_FLOOR, value);
}

float Q3SysCall::Ceil(float value) {
	return syscall_(G_CEIL, value);
}
